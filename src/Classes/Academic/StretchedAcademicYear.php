...
class StretchedAcademicYear implements JsonSerializable
{
    ...
    private function setAutumnTerm() : StretchedTerm
    {
    ...
    private function setSpringTerm() : StretchedTerm
    {
    ...
    private function setSummerTerm() : StretchedTerm
    {
